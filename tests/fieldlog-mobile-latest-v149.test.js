...
test("手機版載入最新版殼與快取", () => {
  assert.match(app, /const APP_VERSION = "155"/);
  assert.match(index, /app\.js\?v=155/);
  assert.match(index, /style\.css\?v=155/);
  assert.match(sw, /app\.js\?v=155/);
  assert.match(sw, /style\.css\?v=155/);
});
