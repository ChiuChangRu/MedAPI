...
const CACHE = "fieldlog-v96-usage-lazy-collapse";
const ASSETS = ["./", "index.html", "app.js?v=96", "style.css?v=96", "home.css", "pdf-editor.js?v=96", "richtext-editor.js?v=96", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
