...
const CACHE = "fieldlog-v128-view-loading";
const ASSETS = ["./", "index.html", "app.js?v=128", "style.css?v=128", "home.css", "pdf-editor.js?v=128", "richtext-editor.js?v=128", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
