...
const CACHE = "fieldlog-v32";
const ASSETS = ["./", "index.html", "app.js?v=32", "style.css?v=32", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
