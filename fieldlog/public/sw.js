...
const CACHE = "fieldlog-v86-version-check";
const ASSETS = ["./", "index.html", "app.js?v=86", "style.css?v=86", "home.css", "pdf-editor.js?v=86", "richtext-editor.js?v=86", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
