...
const CACHE = "fieldlog-v67-version-check";
const ASSETS = ["./", "index.html", "app.js?v=67", "style.css?v=67", "home.css", "pdf-editor.js?v=67", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
