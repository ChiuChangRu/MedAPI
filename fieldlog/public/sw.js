...
const CACHE = "fieldlog-v95-folder-categories";
const ASSETS = ["./", "index.html", "app.js?v=95", "style.css?v=95", "home.css", "pdf-editor.js?v=95", "richtext-editor.js?v=95", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
