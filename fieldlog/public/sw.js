...
const CACHE = "fieldlog-v64-version-check";
const ASSETS = ["./", "index.html", "app.js?v=64", "style.css?v=64", "home.css", "pdf-editor.js?v=64", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
