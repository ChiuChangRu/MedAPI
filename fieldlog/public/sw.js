...
const CACHE = "fieldlog-v132-boot-progress";
const ASSETS = ["./", "index.html", "app.js?v=132", "style.css?v=132", "home.css", "pdf-editor.js?v=132", "richtext-editor.js?v=132", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
