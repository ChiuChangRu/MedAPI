...
const CACHE = "fieldlog-v74-version-check";
const ASSETS = ["./", "index.html", "app.js?v=74", "style.css?v=74", "home.css", "pdf-editor.js?v=74", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
