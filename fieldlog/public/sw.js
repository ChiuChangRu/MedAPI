...
const CACHE = "fieldlog-v116-audio-warmup";
const ASSETS = ["./", "index.html", "app.js?v=116", "style.css?v=116", "home.css", "pdf-editor.js?v=116", "richtext-editor.js?v=116", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
