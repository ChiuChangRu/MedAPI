...
const CACHE = "fieldlog-v68-version-check";
const ASSETS = ["./", "index.html", "app.js?v=68", "style.css?v=68", "home.css", "pdf-editor.js?v=68", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
