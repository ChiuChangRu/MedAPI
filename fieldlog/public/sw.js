...
const CACHE = "fieldlog-v55-version-check";
const ASSETS = ["./", "index.html", "app.js?v=55", "style.css?v=55", "home.css", "pdf-editor.js?v=55", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
