...
const CACHE = "fieldlog-v75-version-check";
const ASSETS = ["./", "index.html", "app.js?v=75", "style.css?v=75", "home.css", "pdf-editor.js?v=75", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
