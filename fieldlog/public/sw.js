...
const CACHE = "fieldlog-v70-version-check";
const ASSETS = ["./", "index.html", "app.js?v=70", "style.css?v=70", "home.css", "pdf-editor.js?v=70", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
