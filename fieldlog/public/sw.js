...
const CACHE = "fieldlog-v82-version-check";
const ASSETS = ["./", "index.html", "app.js?v=82", "style.css?v=82", "home.css", "pdf-editor.js?v=82", "richtext-editor.js?v=82", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
