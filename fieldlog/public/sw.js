...
const CACHE = "fieldlog-v98-quiet-empty-inbox";
const ASSETS = ["./", "index.html", "app.js?v=98", "style.css?v=98", "home.css", "pdf-editor.js?v=98", "richtext-editor.js?v=98", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
