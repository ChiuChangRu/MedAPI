...
const CACHE = "fieldlog-v89-recent-updated-at-fix";
const ASSETS = ["./", "index.html", "app.js?v=89", "style.css?v=89", "home.css", "pdf-editor.js?v=89", "richtext-editor.js?v=89", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
