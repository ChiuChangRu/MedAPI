...
const CACHE = "fieldlog-v41";
const ASSETS = ["./", "index.html", "app.js?v=41", "style.css?v=34", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
