...
const CACHE = "fieldlog-v9";
const ASSETS = ["./", "index.html", "app.js?v=9", "style.css?v=9", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
