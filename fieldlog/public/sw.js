...
const CACHE = "fieldlog-v45";
const ASSETS = ["./", "index.html", "app.js?v=45", "style.css?v=45", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
