...
const CACHE = "fieldlog-v77-version-check";
const ASSETS = ["./", "index.html", "app.js?v=77", "style.css?v=77", "home.css", "pdf-editor.js?v=77", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
