...
const CACHE = "fieldlog-v8";
const ASSETS = ["./", "index.html", "app.js?v=8", "style.css?v=8", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
