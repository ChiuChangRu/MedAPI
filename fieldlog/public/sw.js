...
const CACHE = "fieldlog-v54-fold-home-js";
const ASSETS = ["./", "index.html", "app.js?v=54", "style.css?v=54", "home.css", "pdf-editor.js?v=54", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
