...
const CACHE = "fieldlog-v53-force-redeploy";
const ASSETS = ["./", "index.html", "app.js?v=53", "style.css?v=53", "home.css", "home.js?v=53", "pdf-editor.js?v=53", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
