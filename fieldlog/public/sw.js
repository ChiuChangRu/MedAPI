...
const CACHE = "fieldlog-v10";
const ASSETS = ["./", "index.html", "app.js?v=10", "style.css?v=10", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
