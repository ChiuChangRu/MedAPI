...
const CACHE = "fieldlog-v119-audio-resume-revert";
const ASSETS = ["./", "index.html", "app.js?v=119", "style.css?v=119", "home.css", "pdf-editor.js?v=119", "richtext-editor.js?v=119", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
