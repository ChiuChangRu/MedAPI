...
const CACHE = "fieldlog-v80-version-check";
const ASSETS = ["./", "index.html", "app.js?v=80", "style.css?v=80", "home.css", "pdf-editor.js?v=80", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
