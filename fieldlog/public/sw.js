...
const CACHE = "fieldlog-v110-unified-explorer";
const ASSETS = ["./", "index.html", "app.js?v=110", "style.css?v=110", "home.css", "pdf-editor.js?v=110", "richtext-editor.js?v=110", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
