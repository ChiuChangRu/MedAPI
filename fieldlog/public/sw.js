...
const CACHE = "fieldlog-v102-tree-indent-and-chip-cleanup";
const ASSETS = ["./", "index.html", "app.js?v=102", "style.css?v=102", "home.css", "pdf-editor.js?v=102", "richtext-editor.js?v=102", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
