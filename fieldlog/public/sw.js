...
const CACHE = "fieldlog-v62-version-check";
const ASSETS = ["./", "index.html", "app.js?v=62", "style.css?v=62", "home.css", "pdf-editor.js?v=62", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
