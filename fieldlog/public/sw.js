...
const CACHE = "fieldlog-v65-version-check";
const ASSETS = ["./", "index.html", "app.js?v=65", "style.css?v=65", "home.css", "pdf-editor.js?v=65", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
