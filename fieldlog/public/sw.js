...
const CACHE = "fieldlog-v48";
const ASSETS = ["./", "index.html", "app.js?v=48", "style.css?v=48", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
