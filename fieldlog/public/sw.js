...
const CACHE = "fieldlog-v88-custom-days-folder-sort";
const ASSETS = ["./", "index.html", "app.js?v=88", "style.css?v=88", "home.css", "pdf-editor.js?v=88", "richtext-editor.js?v=88", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
