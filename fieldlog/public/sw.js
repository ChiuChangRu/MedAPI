...
const CACHE = "fieldlog-v83-version-check";
const ASSETS = ["./", "index.html", "app.js?v=83", "style.css?v=83", "home.css", "pdf-editor.js?v=83", "richtext-editor.js?v=83", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
