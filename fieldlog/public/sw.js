...
const CACHE = "fieldlog-v105-background-audio-recovery";
const ASSETS = ["./", "index.html", "app.js?v=105", "style.css?v=105", "home.css", "pdf-editor.js?v=105", "richtext-editor.js?v=105", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
