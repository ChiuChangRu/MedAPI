...
const CACHE = "fieldlog-v127-search-blank-fix";
const ASSETS = ["./", "index.html", "app.js?v=127", "style.css?v=127", "home.css", "pdf-editor.js?v=127", "richtext-editor.js?v=127", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
