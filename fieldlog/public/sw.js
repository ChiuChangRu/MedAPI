...
const CACHE = "fieldlog-v33";
const ASSETS = ["./", "index.html", "app.js?v=33", "style.css?v=33", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
