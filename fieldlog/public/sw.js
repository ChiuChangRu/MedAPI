...
const CACHE = "fieldlog-v90-zero-day-autofile";
const ASSETS = ["./", "index.html", "app.js?v=90", "style.css?v=90", "home.css", "pdf-editor.js?v=90", "richtext-editor.js?v=90", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
