...
const CACHE = "fieldlog-v87-staging-autofile";
const ASSETS = ["./", "index.html", "app.js?v=87", "style.css?v=87", "home.css", "pdf-editor.js?v=87", "richtext-editor.js?v=87", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
