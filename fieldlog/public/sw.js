...
const CACHE = "fieldlog-v60-version-check";
const ASSETS = ["./", "index.html", "app.js?v=60", "style.css?v=60", "home.css", "pdf-editor.js?v=60", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
