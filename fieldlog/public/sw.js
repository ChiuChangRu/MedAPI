...
const CACHE = "fieldlog-v69-version-check";
const ASSETS = ["./", "index.html", "app.js?v=69", "style.css?v=69", "home.css", "pdf-editor.js?v=69", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
