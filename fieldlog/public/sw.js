...
const CACHE = "fieldlog-v66-version-check";
const ASSETS = ["./", "index.html", "app.js?v=66", "style.css?v=66", "home.css", "pdf-editor.js?v=66", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
