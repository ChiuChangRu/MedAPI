...
const CACHE = "fieldlog-v144-work-sections";
const ASSETS = ["./", "index.html", "app.js?v=144", "style.css?v=144", "home.css", "pdf-editor.js?v=144", "richtext-editor.js?v=144", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
