...
const CACHE = "fieldlog-v72-version-check";
const ASSETS = ["./", "index.html", "app.js?v=72", "style.css?v=72", "home.css", "pdf-editor.js?v=72", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
