...
const CACHE = "fieldlog-v11";
const ASSETS = ["./", "index.html", "app.js?v=11", "style.css?v=11", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
