...
const CACHE = "fieldlog-v21";
const ASSETS = ["./", "index.html", "app.js?v=21", "style.css?v=21", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
