...
const CACHE = "fieldlog-v73-version-check";
const ASSETS = ["./", "index.html", "app.js?v=73", "style.css?v=73", "home.css", "pdf-editor.js?v=73", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
