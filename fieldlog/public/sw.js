...
const CACHE = "fieldlog-v56-version-check";
const ASSETS = ["./", "index.html", "app.js?v=56", "style.css?v=56", "home.css", "pdf-editor.js?v=56", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
