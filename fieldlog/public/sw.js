...
const CACHE = "fieldlog-v135-recording-workspace";
const ASSETS = ["./", "index.html", "app.js?v=135", "style.css?v=135", "home.css", "pdf-editor.js?v=135", "richtext-editor.js?v=135", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
