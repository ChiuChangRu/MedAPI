...
const CACHE = "fieldlog-v85-version-check";
const ASSETS = ["./", "index.html", "app.js?v=85", "style.css?v=85", "home.css", "pdf-editor.js?v=85", "richtext-editor.js?v=85", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
