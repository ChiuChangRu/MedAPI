...
const CACHE = "fieldlog-v49-layout-depth4";
const ASSETS = ["./", "index.html", "app.js?v=49-files", "style.css?v=49-files", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
