...
const CACHE = "fieldlog-v76-version-check";
const ASSETS = ["./", "index.html", "app.js?v=76", "style.css?v=76", "home.css", "pdf-editor.js?v=76", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
