...
const CACHE = "fieldlog-v84-version-check";
const ASSETS = ["./", "index.html", "app.js?v=84", "style.css?v=84", "home.css", "pdf-editor.js?v=84", "richtext-editor.js?v=84", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
