...
const CACHE = "fieldlog-v61-version-check";
const ASSETS = ["./", "index.html", "app.js?v=61", "style.css?v=61", "home.css", "pdf-editor.js?v=61", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
