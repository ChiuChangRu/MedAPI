...
const CACHE = "fieldlog-v47";
const ASSETS = ["./", "index.html", "app.js?v=47", "style.css?v=47", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
