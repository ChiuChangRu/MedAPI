...
const CACHE = "fieldlog-v63-version-check";
const ASSETS = ["./", "index.html", "app.js?v=63", "style.css?v=63", "home.css", "pdf-editor.js?v=63", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
