...
const CACHE = "fieldlog-v4";
const ASSETS = ["./", "index.html", "app.js?v=4", "style.css?v=4", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
