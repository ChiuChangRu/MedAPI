...
const CACHE = "fieldlog-v134-evernote-reader";
const ASSETS = ["./", "index.html", "app.js?v=134", "style.css?v=134", "home.css", "pdf-editor.js?v=134", "richtext-editor.js?v=134", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
