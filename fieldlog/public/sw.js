...
const CACHE = "fieldlog-v28";
const ASSETS = ["./", "index.html", "app.js?v=28", "style.css?v=28", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
