...
const CACHE = "fieldlog-v81-version-check";
const ASSETS = ["./", "index.html", "app.js?v=81", "style.css?v=81", "home.css", "pdf-editor.js?v=81", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
