...
const CACHE = "fieldlog-v142-hybrid-autofiling";
const ASSETS = ["./", "index.html", "app.js?v=142", "style.css?v=142", "home.css", "pdf-editor.js?v=142", "richtext-editor.js?v=142", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
