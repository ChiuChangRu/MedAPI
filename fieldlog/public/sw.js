...
const CACHE = "fieldlog-v12";
const ASSETS = ["./", "index.html", "app.js?v=12", "style.css?v=12", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
