...
const CACHE = "fieldlog-v24";
const ASSETS = ["./", "index.html", "app.js?v=24", "style.css?v=24", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
