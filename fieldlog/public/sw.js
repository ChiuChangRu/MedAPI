...
const CACHE = "fieldlog-v120-audio-recovery-retry";
const ASSETS = ["./", "index.html", "app.js?v=120", "style.css?v=120", "home.css", "pdf-editor.js?v=120", "richtext-editor.js?v=120", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
