...
const CACHE = "fieldlog-v26";
const ASSETS = ["./", "index.html", "app.js?v=26", "style.css?v=26", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
