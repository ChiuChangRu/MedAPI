...
const CACHE = "fieldlog-v25";
const ASSETS = ["./", "index.html", "app.js?v=25", "style.css?v=25", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
