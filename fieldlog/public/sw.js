...
const CACHE = "fieldlog-v57-version-check";
const ASSETS = ["./", "index.html", "app.js?v=57", "style.css?v=57", "home.css", "pdf-editor.js?v=57", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
