...
const CACHE = "fieldlog-v150-continuous-audio-photos";
const ASSETS = ["./", "index.html", "app.js?v=150", "style.css?v=150", "home.css", "pdf-editor.js?v=150", "richtext-editor.js?v=150", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
