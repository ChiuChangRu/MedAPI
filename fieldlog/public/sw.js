...
const CACHE = "fieldlog-v71-version-check";
const ASSETS = ["./", "index.html", "app.js?v=71", "style.css?v=71", "home.css", "pdf-editor.js?v=71", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
