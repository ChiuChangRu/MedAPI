...
const CACHE = "fieldlog-v27";
const ASSETS = ["./", "index.html", "app.js?v=27", "style.css?v=27", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
