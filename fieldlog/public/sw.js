...
const CACHE = "fieldlog-v49";
const ASSETS = ["./", "index.html", "app.js?v=49", "style.css?v=49", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
