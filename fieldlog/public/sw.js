...
const CACHE = "fieldlog-v101-add-subfolder-from-tree";
const ASSETS = ["./", "index.html", "app.js?v=101", "style.css?v=101", "home.css", "pdf-editor.js?v=101", "richtext-editor.js?v=101", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
