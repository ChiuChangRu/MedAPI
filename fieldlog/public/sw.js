...
const CACHE = "fieldlog-v159-home-file-upload";
const ASSETS = ["./", "index.html", "app.js?v=159", "style.css?v=159", "home.css", "pdf-editor.js?v=159", "richtext-editor.js?v=159", "wiki.html", "help.html?v=159", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
