...
const CACHE = "fieldlog-v78-version-check";
const ASSETS = ["./", "index.html", "app.js?v=78", "style.css?v=78", "home.css", "pdf-editor.js?v=78", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
