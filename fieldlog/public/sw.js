...
const CACHE = "fieldlog-v115-audio-defer";
const ASSETS = ["./", "index.html", "app.js?v=115", "style.css?v=115", "home.css", "pdf-editor.js?v=115", "richtext-editor.js?v=115", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
