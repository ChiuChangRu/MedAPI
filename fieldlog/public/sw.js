...
const CACHE = "fieldlog-v51-image-viewer";
const ASSETS = ["./", "index.html", "app.js?v=51", "style.css?v=51", "home.css", "home.js?v=51", "pdf-editor.js?v=51", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
