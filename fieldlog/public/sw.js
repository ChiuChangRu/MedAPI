...
const CACHE = "fieldlog-v79-version-check";
const ASSETS = ["./", "index.html", "app.js?v=79", "style.css?v=79", "home.css", "pdf-editor.js?v=79", "wiki.html", "help.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
