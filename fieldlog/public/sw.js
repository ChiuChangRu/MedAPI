...
const CACHE = "fieldlog-v7";
const ASSETS = ["./", "index.html", "app.js?v=7", "style.css?v=7", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
