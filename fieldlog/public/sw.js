...
const CACHE = "fieldlog-v43";
const ASSETS = ["./", "index.html", "app.js?v=43", "style.css?v=43", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
