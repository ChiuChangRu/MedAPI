...
const CACHE = "fieldlog-v52-usage-lag";
const ASSETS = ["./", "index.html", "app.js?v=52", "style.css?v=52", "home.css", "home.js?v=52", "pdf-editor.js?v=52", "wiki.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
