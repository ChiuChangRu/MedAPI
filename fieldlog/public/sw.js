...
const CACHE = "fieldlog-v122-webaudio-relay";
const ASSETS = ["./", "index.html", "app.js?v=122", "style.css?v=122", "home.css", "pdf-editor.js?v=122", "richtext-editor.js?v=122", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
