...
const CACHE = "fieldlog-v109-explorer-trash";
const ASSETS = ["./", "index.html", "app.js?v=109", "style.css?v=109", "home.css", "pdf-editor.js?v=109", "richtext-editor.js?v=109", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
