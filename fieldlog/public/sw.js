...
const CACHE = "fieldlog-v114-audio-recovery";
const ASSETS = ["./", "index.html", "app.js?v=114", "style.css?v=114", "home.css", "pdf-editor.js?v=114", "richtext-editor.js?v=114", "wiki.html", "help.html", "patrol.html", "manifest.json", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png"];
